...
public class PGPView : Gtk.Grid  {
    ...
    construct {
        ...
        labelTitle = new Gtk.Label ("PGP Encryption");
        ...
        button.clicked.connect (() => {
         try {
                        AppInfo.launch_default_for_uri ("https://en.wikipedia.org/wiki/Pretty_Good_Privacy", null);
                    } catch (Error e) {
                        warning (e.message);
                    }
        });
        ...
        enchiperButton.clicked.connect (() => {
            ...
            cipherText = "";
            cipherTextTextView.buffer.text = pgp.encryptPGP (plainText);
        });
        ...
        dechiperButton.clicked.connect (() => {
            ...
            plainTextTextView.buffer.text = pgp.decryptPGP (cipherText);
        });
    }
